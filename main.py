...
def search_wolframAlpha(query=''):
    ...
    # Query resolves
        ...
        if (('result') in pod1['@title'].lower()) or (pod1.get('@primany', 'false') == 'true') or ('definiton' in pod1['@title'].lower()):
            # results
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if query[0] == activationWord:
            ...
            if query[0] == 'say':
                if 'hello' in query:
                    speak('Greetings all. Why you all up in my pussy boy?')
                else:
            ...
            if query[0] == 'wikipedia':
                query = ' '.join(query[1:])
                speak('Querying the universal bank.')
            ...
            if query[0] == 'log':
                ...
                speak('Note recorded and placed in new file')
